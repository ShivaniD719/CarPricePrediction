...
iv) I tried last Liner Regression using fuel, odometer, condition, manufacturer and type columns to see if manufacturer value would bring more value to prediction. The MSE came out very high (332 Trillion), however, the odometer co-efficient is in negative number which looks reasonable. However, due to much lower value of co-efficient, I will use linreg12 to make recommendations.
